...
from .views import Libro_list, Book_create, Book_details, Book_edit, Book_delete, Prestamo_create
...
urlpatterns = [
    ...
    path('biblioteca/prestamoCreate/<int:pk>', Prestamo_create.as_view(), name='prestamo_create')
]